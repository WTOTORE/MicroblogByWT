...
+(instancetype)itemWithImageName:(NSString *)imageName target:(id)target action:(SEL)action {
    ...
    [btn setImage:[WTXMSkinImage skinImageNamed:imageName] forState:UIControlStateNormal];
    NSString *imageNameHighlighted=[NSString stringWithFormat:@"%@_highlighted",imageName];
    [btn setImage:[WTXMSkinImage skinImageNamed:imageNameHighlighted] forState:UIControlStateHighlighted];
    [btn sizeToFit];
